...
import com.example.afinal.feature.home.domain.entitites.Status
...
class LoanViewHolder(
    ...
    fun bind(loan: Loan) {
        with(binding) {
            ...
            sum.text = root.context.getString(ComponentR.string.sum).format(formatter.format(loan.amount))
